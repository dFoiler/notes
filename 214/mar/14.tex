...
\begin{proof}
	...
	It remains to check that $p\mapsto D_p$ is smooth. Well, we work locally on a smooth chart $(U,\varphi)$ of $M$. Write $\varphi\coloneqq(x_1,\ldots,x_m)$. Then \Cref{rem:vector-field-locally} assures us that we get smooth functions $f_1,\ldots,f_m$ and $g_1,\ldots,g_m$ such that
