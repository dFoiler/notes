...
\end{definition}
\begin{remark}
	Technically, we have not shown that the collection of proper ideals is closed under multiplication. This will follow from \Cref{lem:proper-ideal-order}, allowing this definition to make sense.
\end{remark}
