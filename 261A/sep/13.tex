...
\end{example}
\begin{remark} \label{rem:universal-cover-ses}
...
\begin{definition}[Lie algebra]
	...
	\[\mf g\coloneqq T_eG.\]
	We may also notate $\mf g$ by $\op{Lie}(G)$.
\end{definition}
...
\end{definition}
\begin{remark} \label{rem:lie-algebra-to-invariant}
	...
	\end{itemize}
\end{remark}
\begin{remark} \label{rem:parallelize-lie-group}
