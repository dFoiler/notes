...
\begin{notation}
	...
	\[0\to\OO\mc E\to\OO\left(\frac{-1}{h-1}\right)\to0.\]
...
\begin{proposition}[Drinfeld's lemma]
...
\end{proof}
\begin{remark}
	Adding in the puncture, it follows that
	\[\op{BC}(-1/t)^*\times_{\op{Spd}k}\op{Spd}C=\mc H^{1,\diamond}_{F,C}/F,\]
	where $\mc H^1_{F,C}=\PP^1_F\setminus\QQ$ is Drinfeld's upper-half plane.
\end{remark}
