...
\begin{equation}
	\begin{tikzcd}[cramped]
		...
		0 & {\displaystyle\left(\frac{E(K[n])}{pE(K[n])}\right)^{\op{Gal}(K[n]/K)}} & {\mathrm H^1(K[n];E[p])^{\op{Gal}(K[n]/K)}} & {\mathrm H^1(K[n];E[p])[p]^{\op{Gal}(K[n]/K)}}
...
\begin{definition}[Kolyvagin system]
	...
	\[\mc P_n\coloneqq\sum_{\sigma\in\op{Gal}(K[1]/K)}D_ny_n,\]
