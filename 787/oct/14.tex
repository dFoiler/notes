...
\end{remark}
Now, \Cref{lem:basic-linear-alg} more or less tells us that we are interested in building classes ramified at only certain primes. (Namely, \Cref{lem:basic-linear-alg} only cares about primes of ``type $1$''.) For our story, we will want a more restrictive class.
