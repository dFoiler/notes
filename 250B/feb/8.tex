...
\begin{proof}
	...
	\begin{proof}
		...
		\[I:=(x_1,\ldots,x_m).\]
		Additionally, because $I\subseteq\rad J$, we are promised positiev integers $a_1,\ldots,a_m$ such that $x_k^{a_k}\in J$ for each $x_k$. So we set $n:=a_1+\cdots+a_m$. Indeed, fix some element $y_1\cdots y_n\in I^n$ so that each $y_k\in I$. We can write
