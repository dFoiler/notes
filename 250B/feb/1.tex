...
\begin{theorem}[Jordan--H\"older] \label{thm:jordanholder}
	Fix $M$ an $R$-module which has a composition series. Then all composition series of $M$ have the same length. Namelt, any strictly descending chain of submodules of $M$ can be refined into a composition series of length equal to the length of $M$.
\end{theorem}
\begin{proof}
