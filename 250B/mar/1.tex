...
\begin{proposition} \label{prop:projislocallyfree}
...
\begin{prop} \label{prop:projisflat}
...
\begin{proof}
	...
	\[\frac S{(t-a)S}=\frac{k[x,t]/\left(x^2-t\right)}{(t-a)k[x,t]/\left(x^2-t\right)}\cong\frac{k[x,t]}{\left(x^2-t,t-a\right)}\cong\frac{k[x]}{\left(x^2-a\right)},\]
...
\begin{proof}
	...
	\begin{itemize}
		...
		\[\frac S{(t-a)S}=\frac{k[x,t]/(xt-1)}{(t-a)k[x,t]/(xt-1)}\cong\frac{k[x,t]}{(xt-1,t-a)}\cong\frac{k[x]}{(ax-1)},\]
...
\begin{proof}
	...
	\begin{lemma} \label{lem:flatistorsionfree}
