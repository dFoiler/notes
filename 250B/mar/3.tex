...
\end{proof}
\begin{remark}[Nir]
	I think Professor Serganova showed that $M$ is flat if and only if $\op{Tor}_i^R(M,N)=0$ for any $R$-module $N$ and index $i>0$ (without using the commutativity of $\op{Tor}$), but I have been able to reconstruct this argument.
\end{remark}
