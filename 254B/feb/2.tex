...
\begin{warn}
	Today, we will discuss \Cref{thm:st} under the additional assumptions that $K_\mf P/\QQ_p$ is unramified, where $p$ lies under $\mf P$, and that $\op{End}^0_K(A)\cap E=\OO_E$.
\end{warn}
