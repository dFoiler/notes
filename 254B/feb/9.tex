...
\begin{proof}
	...
	Explicitly, one can use \Cref{thm:bertini} to the blow-up $\op{Bl}_{\{x_0,x_1\}}X\to X$. Then $x_0$ and $x_1$ become codimen\-sion-$1$ closed subvarieties of the blow-up, so we can get them to intersect with a hypersurface (see \Cref{rem:finite-field-bertini}). So we may induct downwards.
\end{proof}
\begin{remark}
