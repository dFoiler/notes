...
\begin{proof}
	...
	\end{listalph}
	By setting $z\coloneqq xy$, we thus see that (a) implies (b), so the hard part is showing the reverse direction. We will finish the proof of this lemma next class.
\end{proof}
\begin{remark}
