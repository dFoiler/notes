...
\begin{proof}
	...
	\begin{itemize}
		...
		\item Essential image: we will do this next class.\todo{What is not in the essential image?} Fix a CM abelian $\CC$-variety $A$. By a spreading out argument that we will give next class (see \Cref{prop:spread-out-av}), there is a finitely generated $k$-algebra $R\subseteq\CC$ such that we have an abelian scheme $\mc A$ over $S\coloneqq\Spec R$ specializing to $A$.
