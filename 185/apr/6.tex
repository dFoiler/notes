...
\begin{proof}
	...
	\begin{center}
		...
		\end{asy}
	\end{center}
	We now rigorize this. Pick up a convex domain $\Omega$. Then, given two paths $\gamma,\eta:[0,1]\to\Omega$, we define $h:[0,1]^2\to\Omega$ by
...
\begin{theorem}[Homotopy independence] \label{thm:homoind}
