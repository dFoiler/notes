...
\begin{proof}
	...
	which is what we wanted.
\end{proof}
\noindent The main point to \autoref{thm:residue} is that it helps us compute integrals, if only we could compute residues. So let's compute residues.
\begin{lemma}
...
\subsection{Examples of the Residue Theorem}
