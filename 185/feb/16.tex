...
\begin{proof}[Proof of \autoref{thm:crsufficient}]
	...
	\begin{align*}
		\lim_{\Delta z\to0}\frac{f(z_0+\Delta z)-f(z_0)}{\Delta z} &= \lim_{\Delta z\to0}\frac{\Delta u}{\Delta z}+i\cdot\lim_{\Delta z\to0}\frac{\Delta v}{\Delta z} \\
		&= \lim_{\Delta z\to0}\frac{u_x(x_0,y_0)\Delta x}{\Delta z}+\lim_{\Delta z\to0}\frac{u_y(x_0,y_0)\Delta y}{\Delta z}+\lim_{\Delta z\to0}E_{ux}+E_{uy}+ \\
		&\qquad\quad i\left(\lim_{\Delta z\to0}\frac{v_x(x_0,y_0)\Delta x}{\Delta z}+\lim_{\Delta z\to0}\frac{v_y(x_0,y_0)\Delta y}{\Delta z}+\lim_{\Delta z\to0}E_{vx}+\lim_{\Delta z\to0}E_{vy}\right) \\
		&= \lim_{\Delta z\to0}\frac{u_x(x_0,y_0)\Delta x}{\Delta z}+\lim_{\Delta z\to0}\frac{u_y(x_0,y_0)\Delta y}{\Delta z}+ \\
		&\qquad\quad i\left(\lim_{\Delta z\to0}\frac{v_x(x_0,y_0)\Delta x}{\Delta z}+\lim_{\Delta z\to0}\frac{v_y(x_0,y_0)\Delta y}{\Delta z}\right),
	\end{align*}
	using the fact that our error terms all vanish.At this point we use the Cauchy--Riemann equations. We see
	\begin{align*}
		\lim_{\Delta z\to0}\frac{f(z_0+\Delta z)-f(z_0)}{\Delta z} &= \lim_{\Delta z\to0}\frac{u_x(x_0,y_0)\Delta x}{\Delta z}-\lim_{\Delta z\to0}\frac{v_x(x_0,y_0)\Delta y}{\Delta z}+ \\
		&\qquad\quad i\left(\lim_{\Delta z\to0}\frac{v_x(x_0,y_0)\Delta x}{\Delta z}+\lim_{\Delta z\to0}\frac{u_x(x_0,y_0)\Delta y}{\Delta z}\right) \\
		&= \lim_{\Delta z\to0}u_x(x_0,y_0)\left(\frac{\Delta x+i\Delta y}{\Delta z}\right)+\lim_{\Delta z\to0}v_x(x_0,y_0)\frac{\Delta x+i\Delta y}{\Delta z},
	\end{align*}
