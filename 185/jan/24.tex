...
\begin{restatable}[Complex numbers]{definition}{complexdefiagain}
...
\begin{definition}[Plus and times in \texorpdfstring{$\CC$}{}]
...
\begin{definition}[Real, imaginary parts]
...
\begin{restatable}[Distance on \texorpdfstring{$\CC$}{C}]{definition}{complexdistdefi}
