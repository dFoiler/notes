...
\end{proof}
\begin{example}
	The same argument of \Cref{prop:skew-field-on-pi-is-skew} shows that any $\mathbb E_1$-ring $R$ is a skew field if $\pi_*R$ is a graded skew field. The converse turns out to also be true.
\end{example}
