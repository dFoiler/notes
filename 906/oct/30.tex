...
\end{example}
\begin{remark}
	The exact same argument shows that any stable $\infty$-category $\mc C$ has internal $\underline{\op{Hom}}$ living in spectra, meaning that it is enriched over spectra. In short, we see
	\[\underline{\op{Hom}}_{\mc C}(A,B)=\Omega\underline{\op{Hom}}_{\mc C}(A,\Sigma B)=\Omega^2\underline{\op{Hom}}_{\mc C}\left(A,\Sigma^2 B\right)=\cdots\]
	because $\Omega$ is a limit and will pass through $\underline{\op{Hom}}_{\mc C}$.
\end{remark}
