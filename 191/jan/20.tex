...
\end{remark}
As an example application, we may give $L(s,\chi)$ an analytic continuation to $\{s:\op{Re}s>0\}$ when $\chi$ is not the principal character. We will need the following result, from \cite{mattner-diff-under-sign}.
