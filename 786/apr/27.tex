...
\begin{notation}
	...
	\[N(F)\to\prod_{\alpha\in\Pi}N_\alpha(F)\cong\prod_{\alpha\in\Pi}F\stackrel\sum\to F\stackrel\psi\to\CC^\times.\]
\end{notation}
\begin{remark}
...
\begin{proof}
	...
	\[f\left(\begin{bmatrix}
		a & 0 \\ c & d
	\end{bmatrix}\right)=\left|\frac ad\right|^{1/2}\chi_1(a)\chi_2(d)f(g).\]
...
\subsection{Whittaker Models over Finite Fields}
...
\end{remark}
\begin{theorem}[Gelfand--Graev] \label{thm:gelfand-graev}
