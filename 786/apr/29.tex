...
\begin{proposition} \label{prop:whittaker-principal-series}
	Fix a split reductive group $G$ over a nonarchimedean local field $F$. Then $\op{Ind}_B^G\chi$ admits a nonzero Whittaker functional, which is unique up to scalar.
\end{proposition}
\begin{proof}
