...
\begin{definition}[automorphic representation]
	Fix a reductive group $G$ over a number field $F$. An \textit{automorphic representation} of $G$ is an irreducible representation of $(\mf g,K_\infty)$ and $G(\AA_F^\infty)$ (with commuting actions) which appears as a subquotient of $\mc A$.
\end{definition}
\begin{remark}
