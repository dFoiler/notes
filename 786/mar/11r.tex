...
\end{theorem}
\begin{example}
	The real Lie group $\op{SL}_2(\RR)$ admits the maximal compact subgroup $\op{SO}_2(\RR)$.
\end{example}
\begin{example}
...
\end{example}
To understand our representations, we must walk the roads lain by Harish--Chandra. We will want to two subspaces of our continuous representations. First, we take smooth vectors.
...
\end{remark}
Second, we take $K$-finite vectors.
