...
\begin{proof}
	...
	\begin{listalph}
		...
		\item Fix some $v\in V_{\mathrm{fin}}$, and we want to show that $Xv\in V_{\mathrm{fin}}$ as well for any $X\in\mf g$. Well, for any $g\in K$, \Cref{lem:group-vs-lie-action} tells us that $g(Xv)=(\op{Ad}_gX)(gv)$, so it follows that
