...
\end{proof}
\begin{example}
	The polynomial $f(x)\coloneqq x^3-2$ is irreducible of degree $3$. So \Cref{thm:dio-thue} implies that $x^3-2y^3=-7$ has only finitely many integer solutions $(x,y)$.
\end{example}
