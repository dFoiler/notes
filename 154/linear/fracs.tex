...
\begin{proof}
	...
	Thus, to prove the desired lower bound, it suffices to show $k_{n+1}k_{n+2}\le(k_{n+1}+k_n)(k_{n+2}-k_n)$. This rearranges to $k_n(k_n+k_{n+1})\le k_nk_{n+2}$, or $k_n+k_{n+2}\le k_{n+2}$, which is true by \Cref{prop:magic-box}.
