...
\begin{proposition} \label{prop:pell-cbrt-2}
	Define the sequence of ordered triples of nonnegative integers $\{(x_0,y_0,z_0)\}_{n=0}^\infty$ recursively by $(x_0,y_0,z_0)\coloneqq(1,0,0)$ and
	\[(x_{n+1},y_{n+1},z_{n+1})=(x_n+2y_n+2z_n,x_n+y_n+2z_n,x_n+y_n+z_n)\]
	for any $n\ge0$. Then for any triple $(x,y,z)$ of nonnegative integers, we have $x^3+2y^3+4z^3-6xyz=1$ if and only if $(x,y,z)=(x_n,y_n,z_n)$ for some $n\ge0$.
\end{proposition}
