...
\begin{proof}
	...
	\end{enumerate}
\end{proof}
The above result is a bit unsatisfying because we have not determined which of $p=a^2+5b^2$ or $2p=a^2+5b^2$ is true. We will explain what is going on in more detail next week, specifically in \Cref{ex:full-primes-of-form-5}.
