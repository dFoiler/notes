...
\begin{proof}
	...
	\begin{itemize}
		...
		\item If $\alpha=\frac12(a+b\sqrt[3]2+\sqrt[3]4)\in\OO_K$ for integers $a,b,c\in\ZZ$, we show that $2\mid a,b,c$. This is essentially the same argument. By subtracting out from $1,\sqrt[3]2,\sqrt[3]4$, we may assume that $a,b,c\in\{0,1\}$. However, by \Cref{ex:norm-k-cbrt-2} tells us that the norm of $\alpha$ is
