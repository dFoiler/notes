...
\begin{example} \label{ex:closedintervalhomeo}
	Continuing from \autoref{ex:lineartransishomeo}, $\varphi_{a,b}\colon\RR\to\RR$ restricts by \autoref{lem:restricthomeo} to a homeomorphism
	\[\varphi_{a,b}|_{[0,1]}\colon[0,1]\to[a,b].\]
\end{example}
\begin{example}
