...
\begin{remark}
	Via \autoref{thm:cx-homs}, we can give $C(X)^*$ a topology such that the map $X\to C(X)^*$ defined by $x\mapsto\op{ev}_x$ is a homeomorphism. % Namely, this is a bijection by \autoref{thm:cx-homs}, and it is a homeomorphism essentially by the definition of the topology on $A^*$.
\end{remark}
