...
\begin{proof}
	...
	\[n>N\implies d_X(x_n,n)\implies d_Y(f(x_n),f(x))<\varepsilon,\]
...
\begin{proof}
	...
	\begin{itemize}
		...
		\begin{align*}
			\widetilde d(\{x_n\},\{y_n\})+\widetilde(\{y_n\},\{z_n\}) &= \lim_{n\to\infty}d(x_n,y_n)+\lim_{n\to\infty}d(y_n,z_n) \\
...
\begin{proof}
	...
	\begin{itemize}
		...
		\[n>N\implies d_Y(y,\varphi(x_n)),d-Y(y',\varphi(x'_n))<\varepsilon/4.\]
