...
\end{remark}
\begin{remark} \label{rem:easier-pw}
...
\begin{corollary} \label{cor:chars-are-dense}
...
\begin{lemma} \label{lem:kernel-is-compact}
...
\end{definition}
\begin{theorem}[Hibert--Schmidt] \label{thm:hilbert-schmidt}
