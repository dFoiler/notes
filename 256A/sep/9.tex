...
\begin{proof}
	...
	\begin{itemize}
		...
		\[\iota_\alpha^\sharp\colon\OO(U)\cong\OO_\alpha(U)\]
		which is natural by the naturality of $\iota_\alpha^\sharp$, so this assembles into a sheaf isomorphism $\iota_\alpha^\sharp\colon\OO|_{U_\alpha\cap U_\beta}\cong\OO_\alpha|_{U_{\alpha\beta}}$. In total, we see that we have assembled an isomorphism
		\[(\iota_\alpha,\iota_\alpha^\sharp)\colon(U_{\alpha\beta},\OO_\alpha|_{U_{\alpha\beta}})\cong(U_\alpha\cap U_\beta,\OO|_{U_\alpha}).\]
