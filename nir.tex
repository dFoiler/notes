...
\definecolor{nirdarkblue}{HTML}{5454f0}
\declaretheoremstyle[
	mdframed={
...
\declaretheorem[style=thmblue,name=Problem,numberwithin=section]{prob}
\declaretheorem[style=thmblue,name=Lemma,sibling=thm]{lem}
\declaretheorem[style=thmblue,name=Lemma,sibling=thm]{lemma}
\declaretheorem[style=thmblue,name=Corollary,sibling=thm]{cor}
\declaretheorem[style=thmblue,name=Corollary,sibling=thm]{corollary}
...
\definecolor{nirdarkgreen}{HTML}{2c8013}
...
\definecolor{nirdarkcyan}{HTML}{2c9971}
...
\declaretheorem[style=exgreen,name=Exercise,sibling=thm]{exercise}
\declaretheorem[style=exgreen,name=Exercise,sibling=thm]{exe}

\definecolor{nirlightbrown}{RGB}{252,240,235}
% \definecolor{nirdarkbrown}{RGB}{180, 133, 75}
\definecolor{nirdarkbrown}{HTML}{a1715d}
\declaretheoremstyle[
	mdframed={
