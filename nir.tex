...
\NewDocumentEnvironment{idea}{o}
	{
		% See definition env for commentary on this code
		
		\vbox\bgroup
			\marginnote{\nirideasymbol}[9pt]
			\IfNoValueTF{#1}{\begin{ideahelper}}{\begin{ideahelper}[#1]}
	}
	{
			\end{ideahelper}
		\egroup
...
\NewDocumentEnvironment{warn}{o}
	{
		...
		\vbox\bgroup
			\marginnote{\nirwarnsymbol}[9pt]
			\IfNoValueTF{#1}{\begin{warnhelper}}{\begin{warnhelper}[#1]}
	}
	{
			\end{warnhelper}
		\egroup
...
\NewDocumentEnvironment{definition}{o}
	{
		% Thank you https://tex.stackexchange.com/a/377293
		% vbox keeps the marginnote attached
		% marginnote is outside the definition because otherwise it will eat the first item in itemize
		% I promise I did not summon Satan
		
		\vbox\bgroup
			\IfNoValueTF{#1}{\begin{defihelper}}{\marginnote{#1}[11.55pt]\begin{defihelper}[#1]}
	}
	{
			\end{defihelper}
		\egroup
